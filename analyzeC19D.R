...
write.table(tot,"~/Desktop/simR.txt",append = FALSE, quote = FALSE,row.names=FALSE, sep="\t")
...
plot(g2, layout=layout_with_fr, vertex.size=10,
     vertex.label.dist=1.5, vertex.color="cyan3", edge.arrow.size=25, main="Network")
dev.new()
 ...
 wc <- cluster_walktrap(g2, weights = E(g2)$weight,
  ...
  plot(wc, g2,vertex.size=10,
      vertex.label.dist=1.5,main="Communities")
